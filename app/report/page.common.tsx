    ...
    return (
      <div className="page page--narrow">
        ...
        <p className="notice">
          ...
          <br />
          {/* 受付番号の使い道として「連絡してください」と促す 1 文を削った（I-10）。
              連絡先がサイトのどこにも無いのに、促す文だけが在った。
              足りないのではなく、約束して果たしていなかった。
              連絡先を置く設計（I-7）は別に在るが、CY_CONTACT_EMAIL が
              決まるまで節が出ないので、そちらが入っても約束は閉じない。
              **消しただけで、果たしてはいない。**
              註: 試験は註釈も含めてソース全体を見るので、ここに元の文言を
              そのまま書き戻すと赤くなる。それでよい —— 註釈から本文へ
              戻ってくる経路も、まとめて塞いでいる。 */}
          運営が内容を確認し、
